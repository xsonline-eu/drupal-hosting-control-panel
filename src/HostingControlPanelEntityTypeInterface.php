...
/**
 * @file
 * Contains \Drupal\hosting_control_panel\HostingControlPanelEntityTypeInterface.
 */
 ...
 */
interface HostingControlPanelEntityTypeInterface extends ConfigEntityInterface {

  /**
   * Gets the description.
   *
   * @return string
   *   The description of this Hosting Control Panel Entity type.
   */
  public function getDescription();

  /**
   * Returns if entities of this Hosting control panel entity are read only.
   *
   * @return bool
  ...
  /**
   * Returns the field mappings of this Hosting Control Panel Entity type.
   *
   * @return array
  ...
  /**
   * Returns the field mapping for the given field of this Hosting Control Panel Entity type.
   *
  ...
  /**
   * Returns the endpoint of this Hosting Control Panel Entity type.
   *
   * @return string
   *   The endpoint for this Hosting Control Panel Entity type.
   */
  public function getEndpoint();

  /**
   * Returns the id of the Hosting control panel entity storage client.
   *
   * @return string
  ...
  /**
   * Returns the parameters of this Hosting Control Panel Entity type.
   *
   * @return array
