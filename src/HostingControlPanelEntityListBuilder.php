...
/**
 * @file
 * Contains \Drupal\hosting_control_panel\HostingControlPanelEntityListBuilder.
 */
 ...
 */
class HostingControlPanelEntityListBuilder extends EntityListBuilder {
  ...
  /**
   * Constructs a new HostingControlPanelEntityListBuilder object.
   *
  ...
  public function buildHeader() {
    ...
    $header = array(
      'title' => $this->t('Title'),
      'type' => array(
        'data' => $this->t('Hosting Control Panel Entity type'),
