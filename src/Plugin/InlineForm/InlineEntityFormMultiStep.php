...
namespace Drupal\hosting_control_panel\Plugin\InlineForm;
 ...
 *
 * @FieldWidget(
 *   id = "inline_entity_form_multi_step",
 *   label = @Translation("Inline entity form - Multi Step"),
 *   field_types = {
 *     "entity_reference"
 *   },
 ...
 * )
 */
class InlineEntityFormMultiStep extends InlineEntityFormBase {
