...
/**
 * @file
 * Contains \Drupal\hosting_control_panel\HostingControlPanelEntityAccessControlHandler.
 */
 ...
 *
 * @see \Drupal\hosting_control_panel\Entity\HostingControlPanelEntity
 * @ingroup hosting_control_panel_entity_access
 */
class HostingControlPanelEntityAccessControlHandler extends EntityAccessControlHandler implements EntityHandlerInterface {
  ...
  /**
   * Constructs a HostingControlPanelEntityAccessControlHandler object.
   *
  ...
  public function access(EntityInterface $entity, $operation, AccountInterface $account = NULL, $return_as_object = FALSE) {
    ...
    $permission = $operation === 'update' ? "edit {$entity->bundle()} Hosting control panel entity" : "{$operation} {$entity->bundle()} Hosting control panel entity";
  ...
  public function createAccess($entity_bundle = NULL, AccountInterface $account = NULL, array $context = array(), $return_as_object = FALSE) {
    ...
    $permission = "create $entity_bundle Hosting control panel entity";
