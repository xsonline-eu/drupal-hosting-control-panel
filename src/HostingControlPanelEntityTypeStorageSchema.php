...
/**
 * @file
 * Contains \Drupal\hosting_control_panel\HostingControlPanelEntityTypeStorageSchema.
 */
 ...
 */
class HostingControlPanelEntityTypeStorageSchema implements DynamicallyFieldableEntityStorageSchemaInterface {
  /**
   * {@inheritdoc}
   */
